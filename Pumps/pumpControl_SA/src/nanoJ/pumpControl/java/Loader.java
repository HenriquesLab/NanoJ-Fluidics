...
public class Loader {
    ...
    static void loadJars(URL url) throws IntrospectionException, MalformedURLException, FileNotFoundException {
    ...
    static void loadLibrary(URL url) throws FileNotFoundException, MalformedURLException {
        String lib;
    ...
    static ArrayList<File> findFilesOfType(URL url, String termination) throws MalformedURLException{
